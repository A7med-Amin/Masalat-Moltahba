...
namespace our {
    ...
    public:
        ...
        // we delete the copy constructor and assignment operator because we do not want to copy the shader program
        // as it is a unique object and we do not want to have multiple copies of it
    };
