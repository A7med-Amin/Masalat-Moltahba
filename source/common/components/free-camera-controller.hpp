...
namespace our {
    ...
    public:
        ...
        glm::vec3 positionSensitivity = {40.0f, 40.0f, 40.0f}; // The unity per second of camera movement if WASD is pressed
        float speedupFactor = 20.0f; // A multiplier for the positionSensitivity if "Left Shift" is held.
